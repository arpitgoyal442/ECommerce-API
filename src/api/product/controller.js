...
const { PRODUCT_TBL, PRODUCT_TYPES_TBL, PRODUCT_ATTR_TBL, ATTRIBUTES_TBL, TABLE_COLS, ITEM_PER_PAGE, CART_TBL } = require("../../constant/constant");
const db = require("../../db")
...
const deleteProduct = async (req, res, next) => {
    ...
    try {
        ...
        let cartQuery=deleteQuery(CART_TBL,condition)
